export default function Home() {
    return (
        <div className="flex flex-row gap-[10px]">
            <div className="flex flex-col flex-2/3 bg-backgroundSecond rounded-md border-2 border-accentSecond">
                <div>Регистрируйте возникающие дефекты</div>
            </div>
            <div className="flex flex-col flex-1/3 text-center bg-backgroundSecond rounded-md border-2 border-accentSecond">
